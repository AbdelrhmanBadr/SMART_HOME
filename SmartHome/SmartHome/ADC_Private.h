...
#define ADC_FOSC_OVER_2		(0X01)
#define ADC_FOSC_OVER_4		(0X02)
#define ADC_FOSC_OVER_8		(0X03)
#define ADC_FOSC_OVER_16	(0X04)
#define ADC_FOSC_OVER_32	(0X05)
#define ADC_FOSC_OVER_64	(0X06)
#define ADC_FOSC_OVER_128	(0X07)
