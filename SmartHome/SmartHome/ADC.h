...
*/
extern uint16 ADC_ReadingValue;

/*
 *@brief: This function is used to initiate ADC
 *@Para :  void
 *@Return: void
 */
void ADC_Initiate(void);
/*
 *@brief: This function is used to start ADC conversion using busy waiting
 *@Para :  1) ADC_Channel
...
/*
 *@brief: This function is used to start ADC conversion using interrupt
 *@Para :  1) ADC_Channel
 *`ADC_SINGLE_ENDED_ADC0`		`ADC_SINGLE_ENDED_ADC1`		`ADC_SINGLE_ENDED_ADC2`	
 *`ADC_SINGLE_ENDED_ADC3`		`ADC_SINGLE_ENDED_ADC4`		`ADC_SINGLE_ENDED_ADC5`	
 *`ADC_SINGLE_ENDED_ADC6`		`ADC_SINGLE_ENDED_ADC7`		`ADC_SINGLE_ENDED_VBG`	
